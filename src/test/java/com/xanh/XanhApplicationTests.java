...
//
//    private PlantController controller = new PlantController(new );
//
//    @Test
//    public void createPlant_Valid_SuccessfullyCreated() {
//        Plant swissCheese = controller.createPlant(name, scientificName);
//
//        assertEquals(name, swissCheese.name);
//        assertEquals(scientificName, swissCheese.scientificName);
//    }
//
//    @Test
